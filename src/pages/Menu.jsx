                ...
                <button
                  ...
                  className={`px-6 py-2 text-sm font-medium ${
                    ...
                    category.id === 'coffee'
                      ...
                      ? 'rounded-r-lg'
                      : ''
                  } border border-coffee-200 transition-colors duration-300`}
                >
                  {category.name}
                </button>
              ))}
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-serif mb-6">Our Specialty Coffee</h2>
              ...
              <ul className="space-y-2 text-mocha-700">
                <li className="flex items-start">
                  <span className="text-coffee-600 mr-2">•</span>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl font-medium text-coffee-800 mb-3">Gluten-Free</h3>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl font-medium text-coffee-800 mb-3">Vegan</h3>
              <p className="text-mocha-600 mb-4">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl font-medium text-coffee-800 mb-3">Low-Sugar Options</h3>
              <p className="text-mocha-600 mb-4">
